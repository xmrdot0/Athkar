...
class _PrayerState extends State<Prayer> {
  ...
  List azkar= [
      [
        Azkar("أستغفر الله", 3),
        Azkar("اللهم أنت السلام ومنك السلام تباركت يا ذا الجلال والإكرام",1),
        Azkar("لا إله إلا الله وحده لا شريك له له الملك وله الحمد يحيي ويميت وهو على كل شيء قدير",10),
        Azkar("سبحان الله" , 33),
        Azkar("الحمد لله" , 33),
        Azkar("ألله أكبر" , 33),
      ...
      body: Container(
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage("assets/prayer.png"), fit: BoxFit.cover, colorFilter: ColorFilter.linearToSrgbGamma())),
